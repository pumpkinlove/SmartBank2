...
/**
 * Created by xu.nan on 2016/11/10.
 */
...
//        manager.notify(NOTIFICATION_ID, n);
        ...
        PendingIntent pi = PendingIntent.getActivity(this, 0,
                new Intent(this, IndexFragment.class), 0);
...
//            mqttClient = new MqttClient(mqttConnSpec, MyApplication.config.getClientId());
//            String clientID = MQTT_CLIENT_ID + "/" + mPrefs.getString(PREF_DEVICE_ID, "");
            mqttClient = new MqttClient(mqttConnSpec, MyApplication.config.getClientId(), new MemoryPersistence());
